...
# DemP repo version — CSVs live in data/processed/, DB written to data/
# Note: Cairn repo version uses different paths. These are intentionally diverged.
PROJECT_ROOT = Path(__file__).parent.parent
DATA_ROOT = PROJECT_ROOT / "data" / "processed"
DB_PATH_ROOT = PROJECT_ROOT / "data"
DEMAND_CSV = DATA_ROOT / "demand_surface.csv"
FACILITIES_CSV = DATA_ROOT / "facilities_with_planning_area.csv"
DB_PATH = DB_PATH_ROOT / "cairn.db"
